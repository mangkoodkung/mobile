...
class MobilePhone {
                    ...
                    <div class="mobile-phone-screen">
                        ...
                        <div class="mobile-status-bar">
                            <div class="status-left">
                                <span class="network-name" id="network-name">POPKO-STTH</span>
                            </div>
                        ...
                        <div class="mobile-content" id="mobile-content">
                            ...
                            <div class="home-screen" id="home-screen">
                                ...
                                <div class="weather-card">
                                    ...
                                    <div class="weather-info">
                                        <span class="weather-desc">มีเมฆมาก ฝนตกเล็กน้อย</span>
                                    </div>
                                </div>
                                ...
                                <div class="app-pages-container">
                                    <div class="app-pages-wrapper" id="app-pages-wrapper">
                                        ...
                                        <div class="app-page">
                                            <div class="app-grid">
                                                <!-- แอพพลิเคชั่น แถวที่ 1：ข้อความ，ร้านค้า，To-do-list -->
                                                <div class="app-row">
                                                    ...
                                                    <div class="app-icon" data-app="shop">
                                                        <div class="app-icon-bg purple">ร้านค้า</div>
                                                        <span class="app-label">ร้านค้า</span>
                                                    </div>
                                                    <div class="app-icon" data-app="task">
                                                        <div class="app-icon-bg purple">📰</div>
                                                        <span class="app-label">To-do-list</span>
                                                    </div>
                                                </div>
                                                <!-- แอพพลิเคชั่น แถวที่ 2：เว็บบอร์ด，Weibo，Live center -->
                                                <div class="app-row">
                                                    <div class="app-icon" data-app="forum">
                                                        <div class="app-icon-bg red">📰</div>
                                                        <span class="app-label">เว็บบอร์ด</span>
                                                    </div>
                                                    <div class="app-icon" data-app="weibo">
                                                        <div class="app-icon-bg orange" style="font-size: 22px;color:rgba(0,0,0,0.4)">Weibo</div>
                                                        <span class="app-label">weibo</span>
                                                    </div>
                                                    <div class="app-icon" data-app="live">
                                                        <div class="app-icon-bg red">🎬</div>
                                                        <span class="app-label">Live Canter</span>
                                                    </div>
                                                </div>
                                                <!-- 第三行：กระเป๋า，API，เอกสาร -->
                                                <div class="app-row">
                                                    ...
                                                    <div class="app-icon" data-app="api">
                                                        <div class="app-icon-bg orange" style="font-size: 22px;color:rgba(0,0,0,0.4)">API</div>
                                                        <span class="app-label">API</span>
                                                    </div>
                                                    <div class="app-icon" data-app="profile">
                                                        <div class="app-icon-bg green">📋</div>
                                                        <span class="app-label">เอกสาร</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <!-- แอพพลิเคชั่นหน้าที่ 2 -->
                                        <div class="app-page">
                                            <div class="app-grid">
                                                <!-- 第一行：相册，邮件，音乐 -->
                                                <div class="app-row">
                            ...
                            <div class="app-screen" id="app-screen" style="display: none;">
                                <div class="app-header" id="app-header">
                                    ...
                                    <h1 class="app-title" id="app-title">แอพพลิเคชั่น</h1>
  ...
  async handleParallelEventsApp() {
    try {
      ...
      // 如果全局变量不存在，尝试简单加载
      if (
        !window.ParallelEventsApp ||
        !window.getParallelEventsAppContent ||
        !window.bindParallelEventsAppEvents ||
        !window.parallelEventsStyles
      ) {
                        ...
                        <div class="parallel-events-container">
                            ...
                            <div class="setting-group">
                                ...
                                <select id="parallel-events-style-select">
                                    <option value="被ntr" ${
                                      parallelEventsSettings.selectedStyle === '被ntr' ? 'selected' : ''
                                    }>被ntr</option>
                                    <option value="主人的任务" ${
                                      parallelEventsSettings.selectedStyle === '主人的任务' ? 'selected' : ''
                                    }>主人的任务</option>
                                    <option value="主动消息" ${
                                      parallelEventsSettings.selectedStyle === '主动消息' ? 'selected' : ''
                                    }>主动消息</option>
                                    <option value="平行事件" ${
                                      parallelEventsSettings.selectedStyle === '平行事件' ? 'selected' : ''
                                    }>平行事件</option>
                                    <option value="魅魔之体" ${
                                      parallelEventsSettings.selectedStyle === '魅魔之体' ? 'selected' : ''
                                    }>魅魔之体</option>
                                    <option value="随机新闻" ${
                                      parallelEventsSettings.selectedStyle === '随机新闻' ? 'selected' : ''
                                    }>随机新闻</option>
                                    <option value="自定义" ${
                                      parallelEventsSettings.selectedStyle === '自定义' ? 'selected' : ''
                                    }>自定义</option>
                                </select>
                            </div>
                            ...
                            <div class="setting-group">
                                ...
                                <div class="toggle-switch2">
                                    <input type="checkbox" id="parallel-events-enabled" ${
                                      parallelEventsSettings.enabled ? 'checked' : ''
                                    }>
